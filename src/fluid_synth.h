...
int fluid_synth_update_polyphony (fluid_synth_t * synth, char *name,
																	int value);
...
void fluid_synth_dither_s16 (int *dither_index, int len, float *lin,
														 float *rin, void *lout, int loff, int lincr,
