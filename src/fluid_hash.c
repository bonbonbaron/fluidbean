...
static fluid_hashnode_t *new_fluid_hashnode (char *key, void *value,
																						 int type);
...
static fluid_hashnode_t **fluid_hashtable_lookup_node (fluid_hashtable_t *
																											 hash_table, char *key);
 ...
 **/
int
fluid_hashtable_lookup (fluid_hashtable_t * hash_table, char *key,
												void **value, int *type) {
	fluid_hashnode_t *node;
 ...
 **/
void
fluid_hashtable_insert (fluid_hashtable_t * hash_table, char *key,
												void *value, int type) {
	fluid_hashnode_t **node;
 ...
 **/
void
fluid_hashtable_replace (fluid_hashtable_t * hash_table, char *key,
												 void *value, int type) {
	fluid_hashnode_t **node;
...
static void
delete_fluid_hashnode (fluid_hashnode_t * hash_node,
											 fluid_hash_delete_t del) {
	if (del) {
...
static void
delete_fluid_hashnodes (fluid_hashnode_t * hash_node,
												fluid_hash_delete_t del) {
	while (hash_node) {
