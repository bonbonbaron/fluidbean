 ...
 */
	...
	int fluid_rampreset_preset_noteon (fluid_preset_t * preset,
...
/* interface */
	...
	int fluid_ramsfont_iteration_next (fluid_ramsfont_t * sfont,
																		 fluid_preset_t * preset);
/* specific */
...
/* interface */
	...
	int fluid_rampreset_noteon (fluid_rampreset_t * preset,
															fluid_synth_t * synth, int chan, int key,
															int vel);
