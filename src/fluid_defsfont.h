...
typedef struct _SFData {				/* Sound font data structure */
	...
	Inflatable *srcSfDataP;				// MB: this is inflatable data the SF comes from in JB.
...
/* functions */
SFData *sfload_file (Inflatable * infP);
...
int fluid_preset_zone_import_sfont (fluid_preset_zone_t * zone,
																		SFZone * sfzone,
																		fluid_defsfont_t * sfont);
...
int fluid_inst_import_sfont (fluid_inst_t * inst, SFInst * sfinst,
														 fluid_defsfont_t * sfont);
int fluid_inst_set_global_zone (fluid_inst_t * inst,
																fluid_inst_zone_t * zone);
