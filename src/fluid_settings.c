...
static fluid_str_setting_t *new_fluid_str_setting (const char *value,
																									 char *def, int hints,
																									 fluid_str_update_t fun,
																									 void *data) {
...
static fluid_num_setting_t *new_fluid_num_setting (double min, double max,
																									 double def, int hints,
																									 fluid_num_update_t fun,
																									 void *data) {
...
static fluid_int_setting_t *new_fluid_int_setting (int min, int max, int def,
																									 int hints,
																									 fluid_int_update_t fun,
																									 void *data) {
...
fluid_settings_t *new_fluid_settings () {
	fluid_settings_t *settings =
		new_fluid_hashtable (fluid_settings_hash_delete);
	if (settings == NULL) {
		return NULL;
	}
...
static int
fluid_settings_get (fluid_settings_t * settings,
										char **name, int len, void **value, int *type) {
...
static int
fluid_settings_set (fluid_settings_t * settings,
										char **name, int len, void *value, int type) {
	fluid_hashtable_t *table = settings;
	int t;
	void *v;
...
fluid_settings_register_str (fluid_settings_t * settings, const char *name,
	...
	if (!fluid_settings_get (settings, tokens, ntokens, &value, &type)) {
		...
		return fluid_settings_set (settings, tokens, ntokens, setting,
															 FLUID_STR_TYPE);
...
/** returns 1 if the value has been register correctly, zero
    otherwise */
int
fluid_settings_register_num (fluid_settings_t * settings, const char *name,
														 double def, double min, double max, int hints,
...
int fluid_settings_get_type (fluid_settings_t * settings, const char *name) {
	...
	return (fluid_settings_get (settings, tokens, ntokens, &value, &type)) ?
		type : FLUID_NO_TYPE;
}
...
int
fluid_settings_setstr (fluid_settings_t * settings, const char *name,
											 const char *str) {
	char *tokens[MAX_SETTINGS_TOKENS];
	char buf[MAX_SETTINGS_LABEL + 1];
	int ntokens;
...
int
fluid_settings_getstr (fluid_settings_t * settings, const char *name,
											 char **str) {
	int type;
	void *value;
	char *tokens[MAX_SETTINGS_TOKENS];
...
int
fluid_settings_str_equal (fluid_settings_t * settings, const char *name,
													char *s) {
	int type;
	void *value;
	char *tokens[MAX_SETTINGS_TOKENS];
...
int
fluid_settings_add_option (fluid_settings_t * settings, const char *name,
													 char *s) {
	int type;
	void *value;
	char *tokens[MAX_SETTINGS_TOKENS];
...
int
fluid_settings_remove_option (fluid_settings_t * settings, const char *name,
															char *s) {
	int type;
	void *value;
	char *tokens[MAX_SETTINGS_TOKENS];
...
int
fluid_settings_setnum (fluid_settings_t * settings, const char *name,
											 double val) {
	int type;
	void *value;
	fluid_num_setting_t *setting;
...
int
fluid_settings_getnum (fluid_settings_t * settings, const char *name,
											 double *val) {
	int type;
	void *value;
	char *tokens[MAX_SETTINGS_TOKENS];
...
int
fluid_settings_setint (fluid_settings_t * settings, const char *name,
											 int val) {
	int type;
	void *value;
	fluid_int_setting_t *setting;
...
int
fluid_settings_getint (fluid_settings_t * settings, const char *name,
											 int *val) {
	int type;
	void *value;
	char *tokens[MAX_SETTINGS_TOKENS];
