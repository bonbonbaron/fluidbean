 ...
 * Range checking is performed there.*/
void
fluid_chorus_set_speed_Hz (fluid_chorus_t * chorus, fluid_real_t speed_Hz) {
 ...
 * Range checking is performed there.*/
void
fluid_chorus_set_depth_ms (fluid_chorus_t * chorus, fluid_real_t depth_ms) {
...
void
fluid_chorus_processmix (fluid_chorus_t * chorus, fluid_real_t * in,
...
void
fluid_chorus_processreplace (fluid_chorus_t * chorus, fluid_real_t * in,
